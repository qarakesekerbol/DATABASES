-- ==========================================
-- Laboratory Work #2: Advanced DDL Operations (v2 - Fixed Syntax)
-- File: lab2_advanced_ddl-v2.sql
-- ==========================================
...
-- Note: Omitting OWNER automatically sets the owner to the current user in PostgreSQL
...
ALTER TABLE student_records ADD COLUMN extra_credit_points NUMERIC(5, 1);
